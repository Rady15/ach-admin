...
const StatusBadge = ({ status }) => {
    ...
    const statusMap = {
        ...
        inprogress: 'text-info bg-info/10 border-info/20',
        waitingforpayment: 'text-purple-500 bg-purple-500/10 border-purple-500/20',
    ...
    const colorClass = statusMap[status?.toLowerCase()] || 'text-slate-400 bg-slate-500/10 border-slate-500/20';
